...
maxSecPerInstance=600							# allowed time (in seconds) for one instance    CHANGE: 300
maxNotSolved=20								# no of instances the program is allowed to fail to solve. If reached, then the script is aborted    CHANGE: 10
